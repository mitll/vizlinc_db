...
public class VizLincRDBTest {
    ...
    public static void setUpClass() throws SQLException, IOException {
        ...
        db = new VizLincRDB(tempDir.newFolder(), true);
        int id = 0;
        int i;
        PreparedStatement docInsert = db.conn.prepareStatement("INSERT INTO document (document_id, name, path, text) " +
                "VALUES(?, ?, ?, ?)");
        ...
        docInsert.setString(++i, "<DOC><TEXT> abc<PERSON TYPE=\"RELATIVE\">def&amp;ghi</PERSON>jkl </TEXT></DOC>");
        docInsert.execute();

        PreparedStatement entityInsert = db.conn.prepareStatement("INSERT INTO entity (entity_id, type, text, created_by, num_documents, num_mentions) " +
                "VALUES(?, ?, ?, ?, ?, ?)");
        ...
        PreparedStatement mentionInsert = db.conn.prepareStatement("INSERT INTO mention (mention_id, document_id, entity_id, type, text, index, global_id, text_start, text_stop) " +
                "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        document2MentionIds = new HashSet<Integer>(Arrays.asList(mentionDoc2AliceId, mentionDoc2BobId, mentionDoc2LincolnLabId, mentionDoc2Date2012Id));
        mentionIds = new HashSet<Integer>(Arrays.asList(mentionDoc1AliceId, mentionDoc1Bob1Id, mentionDoc1Bob2Id, mentionDoc1LexingtonId,
                    mentionDoc2AliceId, mentionDoc2BobId, mentionDoc2LincolnLabId, mentionDoc2Date2012Id));
        ...
        PreparedStatement documentEntityInsert = db.conn.prepareStatement("INSERT INTO document_entity (document_id, entity_id, num_mentions) " +
                "VALUES(?, ?, ?)");
        ...
        entityIds = new HashSet<Integer>(Arrays.asList(entityAliceId, entityBobId, entityLexingtonId));
        ...
        document2EntityIds = new HashSet<Integer>(Arrays.asList(entityAliceId, entityBobId));

        PreparedStatement geolocationInsert = db.conn.prepareStatement(
    ...
    public static void tearDownClass() throws SQLException {
        ...
        try {
            db.getDocumentWithId(document1Id);
    ...
    /**
     * Test of commit method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of rollback method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of shutdown method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDocuments method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDocumentWithId method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getEntityWithId method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDocumentText method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getGeoLocations method, of class VizLincRDB.
     */
    @Test
    public void testGetGeoLocations() throws Exception {
        List<GeoLocation> geolocs = db.getGeoLocations(entityLexingtonId);
        assertEquals(geolocs.size(), 2);
        assertEquals(entityLexingtonGeoLocation1, geolocs.get(0));
        assertEquals(entityLexingtonGeoLocation2, geolocs.get(1));
    }

    /**
     * Test of getFirstNGeoLocations method, of class VizLincRDB.
     */
    @Test
    public void testGetFirstNGeoLocations() throws Exception {
        List<GeoLocation> geolocs = db.getFirstNGeoLocations(entityLexingtonId, 1);
        assertEquals(1, geolocs.size());
        assertEquals(entityLexingtonGeoLocation1, geolocs.get(0));
    }

    /**
     * Test of getGeoPoints method, of class VizLincRDB.
     */
    @Test
    public void testGetGeoPoints() throws Exception {
        List<GeoPoint> geopoints = db.getGeoPoints(entityLexingtonId);
        assertEquals(2, geopoints.size());
        assertEquals(entityLexingtonGeoPoint1, geopoints.get(0));
        assertEquals(entityLexingtonGeoPoint2, geopoints.get(1));
    }

    /**
     * Test of getFirstNGeoPoints method, of class VizLincRDB.
     */
    @Test
    public void testGetFirstNGeoPoints() throws Exception {
        List<GeoPoint> geopoints = db.getFirstNGeoPoints(entityLexingtonId, 1);
        assertEquals(1, geopoints.size());
        assertEquals(entityLexingtonGeoPoint1, geopoints.get(0));
    }

    /**
     * Test of getTopGeoPointsForLocationEntityIds method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getPersonEntities method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getLocationEntities method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDateEntities method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getOrganizationEntities method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of testGetDocumentIdsWithAllOfTheseEntityIds method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDistinctMentionTextsForEntityId method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of testGetEntityIdsInAnyofTheseDocumentIds method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getMentionCountsForEntitiesInDocuments method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getDocumentCountsForEntitiesInDocuments method, of class VizLincRDB.
     */
    @Test
    public void testGetDocumentCountsForEntitiesInDocuments() throws Exception {
        ...
        assertEquals(entityIdToDocumentCount,
                db.getDocumentCountsForEntitiesInDocuments(Arrays.asList(entityBobId, entityLexingtonId, entityLincolnLabId),
                    Arrays.asList(document1Id, document2Id)));
    }

    /**
     * Test of getDocumentsWithIds method, of class VizLincRDB.
     */
    @Test
    public void testGetDocumentsWithIds() throws Exception {
        assertEquals(Document.listOfDocumentIds(db.getDocumentsWithIds(Arrays.asList(document1Id, document2Id))), Arrays.asList(document1Id, document2Id));
    }

    /**
     * Test of getEntitiesWithIds method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getEntities method, of class VizLincRDB.
     */
    @Test
    public void testGetEntities() throws Exception {
        EntitySet es = db.getEntities();
        assertEquals(Arrays.asList(db.getEntityWithId(entityDate2012Id)), es.getDateEntities());
        assertEquals(Arrays.asList(db.getEntityWithId(entityLexingtonId)), es.getLocationEntities());
        assertEquals(Arrays.asList(db.getEntityWithId(entityLincolnLabId)), es.getOrganizationEntities());
        assertEquals(Arrays.asList(db.getEntityWithId(entityAliceId), db.getEntityWithId(entityBobId)), es.getPersonEntities());
    }

    /**
     * Test of getMentionWithId method, of class VizLincRDB.
     */
    @Test
    ...
    /**
     * Test of getMentions method, of class VizLincRDB.
     */
    @Test
    public void testGetMentions() throws Exception {
        Set<Mention> mentions = new HashSet<Mention>();
        for (int id : mentionIds) {
            mentions.add(db.getMentionWithId(id));
        }
        assertEquals(mentions, new HashSet(db.getMentions()));
    }

    /**
     * Test of getMentionsWithoutText method, of class VizLincRDB.
     */
    @Test
    public void testGetMentionsWithoutText() throws Exception {
        Set<Mention> mentions = new HashSet<Mention>();
        for (int id : mentionIds) {
            Mention m = db.getMentionWithId(id);
            // Create an identical mention except for the text.
            mentions.add(new Mention(m.getId(), m.getDocumentId(), m.getEntityId(), m.getType(), null, m.getIndex(), m.getGlobalId(), m.getTextStart(), m.getTextStop()));
        }
        assertEquals(mentions, new HashSet(db.getMentionsWithoutText()));
    }

    /**
     * Test of getMentionLocations method, of class VizLincRDB.
     */
    @Test
    public void testGetMentionLocations() throws Exception {
        Set<MentionLocation> mentionLocations = new HashSet<MentionLocation>();
        for (int id : mentionIds) {
            Mention m = db.getMentionWithId(id);
            mentionLocations.add(new MentionLocation(m.getDocumentId(), m.getEntityId(), m.getIndex(), m.getTextStart(), m.getTextStop(),m.getType()));
        }
        assertEquals(mentionLocations, new HashSet(db.getMentionLocations()));
    }
